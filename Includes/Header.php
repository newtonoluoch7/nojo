...
<title>nojo | Creative Digital Solutions</title>
...
<body>
	<div class="preloader">
  <div class="inner">
  <figure class="logo"><img src="images/nojo-logo.png" alt="Image" style="height:10%;" ></figure>
...
<aside class="left-side">
 <!-- <div class="logo">
 	<img src="images/nojo-logo-icon.png" alt="nojo-logo-icon">
 </div> -->
  <ul>
    <li><a href="#">FACEBOOK</a></li>
    <li><a href="https://www.behance.net/newtonoluoch">BEHANCE</a></li>
...
<header class="header">
  <nav class="navbar">
	  <div class="inner">
    <div class="logo"> <a href="index.php"><img src="images/nojo-logo.png" alt="nojo logo" style="height: 100px;" ></a> </div>
    <!-- end logo -->
    <div class="phone"> T: +254 708818032 </div>
    <!-- end phone -->
    <div class="main-menu">
      <ul>
